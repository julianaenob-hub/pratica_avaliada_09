    ...
    async function atualizarUsuario(e: SyntheticEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (axios.isAxiosError(error)) {
                alert(`Erro ao atualizar o usuário (${error.response?.status})`)
                return
            }
        } finally {
            setIsLoading(false)
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr]">
                        ...
                        <div className="bg-indigo-500 p-8 flex flex-col items-center justify-center">
                            <div className="relative">
                                <img
                                    src={user.foto || "https://i.imgur.com/vU2pI3b.png"}
                                    alt={user.nome}
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            <form onSubmit={atualizarUsuario} className="space-y-4">
                                ...
                                <div className="flex justify-around gap-8 pt-4">
                                    <button
                                        type="button"
                                        className="rounded text-white bg-red-400 hover:bg-red-700 w-1/2 py-2 font-bold cursor-pointer"
                                        onClick={retornar}
                                    >
                                        Cancelar
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className="rounded text-white bg-indigo-400 hover:bg-indigo-900 
                                                   w-1/2 py-2 flex justify-center font-bold cursor-pointer"
                                        disabled={isLoading}
                                    >
                                        {isLoading ? (
